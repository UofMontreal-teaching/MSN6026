...
p <- p +   geom_ribbon(data=subset(mydata,x<=qlnorm( perc ,meanlog = log(gm1), sdlog = log(gsd1))),aes(ymax=y),ymin=0,
              fill="darkgrey",colour=NA,alpha=I(1/3))
...
#    ggsave("C:/jerome/Dropbox/bureau/cours université de Montréal/figures-images/formations strats/pop_Vs_incert1_en.jpeg", width = 11, height = 6, units = "cm",dpi=600) 
...
#      ggsave("C:/jerome/Dropbox/bureau/cours université de Montréal/figures-images/formations strats/pop_Vs_incert2_en.jpeg", width = 11, height = 6, units = "cm",dpi=600) 
...
p <- p + scale_fill_manual(values=c("cornsilk3", "darkgrey"))
...
#    ggsave("C:/jerome/Dropbox/bureau/cours université de Montréal/figures-images/formations strats/pop_Vs_incert3_en.jpeg", width = 11, height = 6, units = "cm",dpi=600) 
...
#     ggsave("C:/jerome/Dropbox/bureau/cours université de Montréal/figures-images/formations strats/pop_Vs_incert4_en.jpeg", width = 11, height = 6, units = "cm",dpi=600) 
